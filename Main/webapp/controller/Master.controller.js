sap.ui.define([
	...
	return BaseController.extend("opensap.Main.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				QuantityPerUnit : function(oContext) {
					var iNumber = oContext.getProperty('QuantityPerUnit'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "opensap.Main.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog : function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
					case "Filter1" :
						aFilters.push(new Filter("QuantityPerUnit", FilterOperator.LE, 100));
						break;
					case "Filter2" :
						aFilters.push(new Filter("QuantityPerUnit", FilterOperator.GT, 100));
						break;
					default :
						break;
				}
